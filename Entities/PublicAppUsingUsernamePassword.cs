    ...
    public class PublicAppUsingUsernamePassword
    {
        ...
        private async Task<AuthenticationResult> GetTokenForWebApiUsingUsernamePasswordAsync(IEnumerable<string> scopes, string username, SecureString password)
        {
            ...
            catch (MsalUiRequiredException ex)
            {
                ...
                ExceptionBase.HandleException(ex, $"Error loggig in user on AD, reason {ex.Message}");
            ...
            {
                ExceptionBase.HandleException(ex, "Error loggig in user on AD, reason : invalid_request");
                // ------------------------------------------------------------------------
            ...
            {
                ExceptionBase.HandleException(ex, "Error loggig in user on AD, reason : unauthorized_client");
                // ------------------------------------------------------------------------
            ...
            {
                ExceptionBase.HandleException(ex, "Error loggig in user on AD, reason : invalid_client");
                // ------------------------------------------------------------------------
            ...
            catch (MsalClientException ex) when (ex.ErrorCode == "unknown_user_type")
            {
                ...
                throw new ArgumentException("Error loggig in user on AD, reason : unknown_user_type", ex);
            }
            catch (MsalClientException ex) when (ex.ErrorCode == "user_realm_discovery_failed")
            {
                ExceptionBase.HandleException(ex, "Error loggig in user on AD, reason : user_realm_discovery_failed");
                // The user is not recognized as a managed user, or a federated user. Azure AD was not
            ...
            {
                ExceptionBase.HandleException(ex, "Error loggig in user on AD, reason : U/P: Wrong username");
            ...
            {
                ExceptionBase.HandleException(ex, "Error loggig in user on AD, reason : parsing_wstrust_response_failed");
                // ------------------------------------------------------------------------
